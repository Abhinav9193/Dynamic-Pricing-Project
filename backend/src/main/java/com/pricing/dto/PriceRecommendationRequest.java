...
public class PriceRecommendationRequest {
    ...
    public PriceRecommendationRequest() {
    }

    public PriceRecommendationRequest(Long product_id, double current_price, int inventory, double competitor_price,
            int demand_score) {
    ...
    public int getDemand_score() {
        return demand_score;
    }

    public void setDemand_score(int demand_score) {
        this.demand_score = demand_score;
    }
}
